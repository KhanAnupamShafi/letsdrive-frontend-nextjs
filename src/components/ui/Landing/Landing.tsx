...
import profilePic from '/public/landing-1.jpeg';
import profilePictwo from '/public/landing-2.png';
    ...
    <>
      <section className="relative bg-[var(--bg-1)] border-t lg:border-t-0">
        ...
        <Image
          ...
          width={508}
          height={642}
          className="absolute hidden lg:block w-[25%] left-0  z-[2]"
          style={{ color: 'transparent' }}
          src={profilePic}
        />
        <img
          ...
          style={{ color: 'transparent' }}
          src="https://placewisetw.vercel.app/_next/image?url=%2Fimg%2Fprimary-hero-el-3.png&w=256&q=75&dpl=dpl_42kWG5pc2HFwKaqT2KDFDUp5BMqR"
        />
        <img
          alt="image"
          width={109}
          ...
          style={{ color: 'transparent' }}
          src="https://placewisetw.vercel.app/_next/image?url=%2Fimg%2Fprimary-hero-el-4.png&w=256&q=75&dpl=dpl_42kWG5pc2HFwKaqT2KDFDUp5BMqR"
        />
        <img
          alt="image"
          width={41}
          height={45}
          className="absolute left-0 lg:left-[25%]"
          style={{ color: 'transparent' }}
          src="https://placewisetw.vercel.app/_next/image?url=%2Fimg%2Fprimary-hero-el-5.png&w=96&q=75&dpl=dpl_42kWG5pc2HFwKaqT2KDFDUp5BMqR"
        />
        <img
          alt="image"
          width={105}
          ...
          style={{ color: 'transparent' }}
          src="https://placewisetw.vercel.app/_next/image?url=%2Fimg%2Fprimary-hero-el-6.png&w=256&q=75&dpl=dpl_42kWG5pc2HFwKaqT2KDFDUp5BMqR"
        />
      </section>
        ...
        <div className="container">
          <div className="text-center relative z-[2]">
            ...
            <p className="text-xl mx-auto max-w-[600px] text-gray-500 mt-4 md:mt-9">
              Explore and Book Your Dream Car Today get exclusive
              rates for your trip
            </p>
